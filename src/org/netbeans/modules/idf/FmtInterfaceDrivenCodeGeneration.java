...
public class FmtInterfaceDrivenCodeGeneration extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("As declared");

        buttonGroup1.add(jCheckBox2);
        jCheckBox2.setText("Alphabetical");

        buttonGroup1.add(jCheckBox3);
        jCheckBox3.setText("By increasing generality");

        buttonGroup1.add(jCheckBox4);
        jCheckBox4.setText("By decreasing generality");

        buttonGroup1.add(jCheckBox5);
        jCheckBox5.setSelected(true);
        jCheckBox5.setText("None of the above");
